...
//                 }),
//           (c.trim = function(a) {
//             return a.trim ? a.trim() : a.replace(/^\s+|\s+N/g, "");
//           }),
//           (c.bind = function() {
...
//               e.match(/^\d+N/) || f.push(l(a, b, c, d, e, !0));
//             }),
//             f
//           );
//         }
...
//             u(g))
//           ) {
//             if (f && e.match(/^\d+N/)) return i;
//             (g = JSON.stringify("" + e)),
//               g.match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"N/)
