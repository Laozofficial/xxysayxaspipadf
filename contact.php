	...
	if(!empty($name) and !empty($email) and !empty($subject) and !empty($message)    ){
		...
		//$sql_query = mysqli_query($connection, $query);
						if (mysqli_query($connection, $query)) {
                            ...
                            //header("Location: register.php?success=upload successful");
                        } else {
                            $errors .= '<div class="alert alert-danger" role="alert">
		  ...
		  <div class="contact-grid-agile-w3s">
				<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w31">
							...
							<h4>Address</h4>
							<p>Ikeja , 45 Building Road <span>Lagos, NIGERIA.</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w32">
							...
							<h4>Call Us</h4>
							<p>+234 9098 311 785<span>+234 9055 551 728</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="mailto:support@elitestores.com">support@elitestores.com</a><span><a href="mailto:support@elitestores.com">support@elitestores.com</a></span></p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
				...
				<div class="agile-contact-left">
						...
						<h4>For More <span>Information</span></h4>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Telephone </p><span>+234 9055 551 728</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="mailto:support@elitestores.com">support@elitestores.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Location</p><span>Ikeja , 45 Building Road <span>Lagos, NIGERIA.</span></span>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="col-md-6 contact-form">
						...
						<form action="contact.php" method="post">
							...
							<input type="submit" name="send-report" value="SEND">
						</form>
					</div>
				</div>
				<div class="clearfix"> </div>
